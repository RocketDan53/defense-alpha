...
POSITIVE_WEIGHTS = {
    SIGNAL_JAR_FUNDING: 3.5,       # Highest — RRAB-validated + budget-validated
    SIGNAL_SBIR_TO_CONTRACT: 3.0,
    SIGNAL_MEIA_EXPERIMENTATION: 3.0,  # Warfighter validation
    SIGNAL_RAPID_GROWTH: 2.5,
    SIGNAL_KOP_ALIGNMENT: 2.5,     # Aligned to ranked Key Operational Problem
    ...
    SIGNAL_PAE_PORTFOLIO: 2.0,     # In PAE portfolio with senior advocate
