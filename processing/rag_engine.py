...
from processing.signal_detector import (
    ...
    SIGNAL_KOP_ALIGNMENT,
    SIGNAL_MEIA_EXPERIMENTATION,
    SIGNAL_JAR_FUNDING,
    SIGNAL_PAE_PORTFOLIO,
...
# Signal weights (mirrored from calculate_composite_scores.py)
POSITIVE_WEIGHTS = {
    SIGNAL_JAR_FUNDING: 3.5,
    SIGNAL_SBIR_TO_CONTRACT: 3.0,
    SIGNAL_MEIA_EXPERIMENTATION: 3.0,
    SIGNAL_RAPID_GROWTH: 2.5,
    SIGNAL_KOP_ALIGNMENT: 2.5,
...
NEGATIVE_WEIGHTS = {
    ...
    SIGNAL_SBIR_LAPSE_RISK: -1.5,
}

ALL_WEIGHTS = {**POSITIVE_WEIGHTS, **NEGATIVE_WEIGHTS}

SIGNAL_DISPLAY_NAMES = {
    SIGNAL_JAR_FUNDING: "JAR Funding",
    SIGNAL_SBIR_TO_CONTRACT: "SBIR->Contract",
    SIGNAL_MEIA_EXPERIMENTATION: "MEIA Experimentation",
    SIGNAL_RAPID_GROWTH: "Rapid Growth",
    SIGNAL_KOP_ALIGNMENT: "KOP Alignment",
    ...
    SIGNAL_PAE_PORTFOLIO: "PAE Portfolio",
