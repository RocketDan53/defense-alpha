...
**Methodology:** Semantic similarity search over 1 technology query, filtered for startups with positive intelligence signals and net-positive composite scores.
...
**Estimated Stage:** Series A  
**Composite Score:** 3.60 (+3.6 / 0.0)  
**Technology Relevance:** 0.412

**Technology Focus:**
- High Bandwidth Air-to-Air and Air-to-Ground Networked Communications for Unmanned Aerial System
- Stratospheric Long Range UAS

**Intelligence Signals:**
- [+] SBIR + VC Raise (score: 1.70)
- [+] Funding Velocity (score: 1.20)
- [+] High-Priority Tech (score: 0.70)

**Financial Summary:**
- 2 SBIR awards ($2.5M)
- Private capital: $9.7M
...
### 4. NANTRAK TACTICAL LLC

**Location:** FRANKLIN, Virginia
**Website:** https://www.nantrak.com/
**Estimated Stage:** Seed / Early  
**Composite Score:** 3.25 (+3.2 / 0.0)  
**Technology Relevance:** 0.403

**Technology Focus:**
- TANGOTRAK Mesh Utility 40mm Projectile - Including Relay, Decoy, Beacon & Motion Sensor
- TANGOTRAK 40mm Satellite Navigation Warfare & Communications Decoy Electronic Warfare Projectiles
- 40mm Rapid Perimeter Deployment System

**Intelligence Signals:**
- [+] SBIR Phase II (score: 1.35)
- [+] Fast SBIR Graduation (score: 1.09)
...
**Estimated Stage:** Series B+  
**Composite Score:** 1.50 (+1.5 / 0.0)  
**Technology Relevance:** 0.528

**Technology Focus:**
- Distributed Dual-Mode Mesh Radar for Base Defense
- Low SWAP-C Multi-function Multi-band Antenna Payload
...
**Financial Summary:**
- 2 SBIR awards ($3.1M)
- Private capital: $32.2M

**Recent Activity:**
- Latest SBIR: 2024-07-01
- Latest Reg D filing: 2023-05-24
...
**Technology Focus:**
- HiBeam.AI: A Highly-Integrated AI-Infused mmWave Beamforming/MIMO System for Directional Wireless Networking in Air, Space, and Ground
...
**Financial Summary:**
- 1 SBIR awards ($75K)
- Private capital: $7.3M

**Recent Activity:**
- Latest SBIR: 2023-12-15
- Latest Reg D filing: 2024-09-06
...
**Estimated Stage:** Seed / Early  
**Composite Score:** 2.55 (+2.5 / 0.0)  
**Technology Relevance:** 0.354

**Technology Focus:**
- Beyond Line of Sight Communications Backhaul SWaP Improvements in support of AFSOC Capabilities in Contested Environments
- Improved Enhanced Thermo-Scatter System BLOS Communications Capability in Support of ACE
- Backhaul SWaP Improvements for Operations in Contested Environments

**Intelligence Signals:**
- [+] SBIR Phase II (score: 1.35)
- [+] Fast SBIR Graduation (score: 1.20)

**Financial Summary:**
- 4 SBIR awards ($1.5M)

**Recent Activity:**
- Latest SBIR: 2024-05-10
...
**Technology Focus:**
- Radiation Hardened WiFi Access Point for Spacecraft
- Wide Band Continuous Spacecraft System Communications Terminal
...
**Scoring Methodology:**
- **Composite Score:** Weighted sum of 13 signals (SBIR advancement, contract wins, VC raises, agency breadth, risk factors). Higher = stronger momentum.
- **Relevance Score:** Semantic similarity between company R&D portfolio and target technology (0-1 scale).
- **Final Rank:** 65% relevance + 35% normalized composite score.

**Pipeline:**
1. **Semantic Search:** SBIR award titles embedded with `all-MiniLM-L6-v2` sentence-transformer (384-dim vectors). Cosine similarity against technology queries.
2. **Signal Scoring:** Composite score from 14 signal types including SBIR progression, contract wins, VC fundraising, multi-agency interest, and risk indicators (customer concentration, SBIR stalling).
3. **Ranking:** 65% technology relevance + 35% composite signal score.
4. **Filtering:** Startups only, net-positive composite score, at least one positive signal, excluding major defense primes.
